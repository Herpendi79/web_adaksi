...
<head>
    ...
    <title>Webinar Pola Pembelajaran dan Riset S3"</title>

    <!-- Begin Jekyll SEO tag v2.8.0 -->
    <title>Webinar Pola Pembelajaran dan Riset S3 | ADAKSI</title>
...
================================================== -->
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <!-- Post Featured Image -->
                <img class="featured-image img-fluid rounded" src="/assets/images/pola-riset.jpeg" alt="Pola & Riset">
                <!-- End Featured Image -->
                <div class="mainheading">
                    ...
                    <!-- Post Title -->
                    <h1 class="posttitle">Webinar Pola
                                Pembelajaran dan Riset S3, Menjalin Komunikasi Yang Baik dengan Supervisor, Studi dan Keluarga</h1>
                ...
                <!-- Post Content -->
                  <div class="article-post serif-font">
                    <p>🗓 Sabtu, 14 Juni 2025
                        🕘 Pukul 19.30 – 22.00 WIB
                        📍 Via Zoom Meeting</p>

                    <p>🎙 Pola Pembelajaran dan Riset S3, Menjalin Komunikasi Yang Baik dengan Supervisor, Studi dan Keluarga:</p>
                    <ul>
                         <li>👨🏻‍🎓 Maya Rahayu (PhD Candidate, Okayama University Jepang - Beasiswa MEXT </li>
                         <li>👨🏻‍🎓 Adityo Darmawan Sudagung (Development Studies, University of Vienna Austria </li>
                         <li>👨🏻‍🎓 Nizamuddin Sadiq (Applied Linguistics, University of Southmapton UK </li>
                    </ul>
