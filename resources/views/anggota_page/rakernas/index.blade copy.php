                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <small
                                                                                            ...
                                                                                            *Transfer ke <strong
                                                                                                class="text-success">{{ $data->rekening_rakernas->no_rek ?? '-' }}</strong>
                                                                                            , Rek. <strong
                                                                                                class="text-success">{{ $data->rekening_rakernas->nama_bank ?? '-' }}</strong>,
                                                                                            a.n <strong
                                                                                                class="text-success">{{ $data->rekening_rakernas->atas_nama ?? '-' }}</strong>
                                                                                            (Wakil Bendahara
                                                                                            DPP ADAKSI)
                                                                                        </small><br>
                                                                                        <small
                                                                                            class="form-text text-danger">
                                                                                            *Bagi peserta terdaftar yang
                                                                                            <strong
                                                                                                class="text-success">TIDAK
                                                                                                HADIR</strong> saat
                                                                                            kegiatan
                                                                                            maka
                                                                                            <strong class="text-success">
                                                                                                Starter Kit, Baju dan
                                                                                                Lainnya</strong>
                                                                                            dapat diorder lewat <strong
                                                                                                class="text-success">Akun
                                                                                                Shopee ADAKSI</strong>
                                                                                        </small>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.modal').forEach(function(modal) {
                modal.addEventListener('show.bs.modal', function(event) {
                    ...
                    // Event handler perubahan kepengurusan
                    const changeHandler = function() {
                        ...
                        if (selectedValue === 'Anggota Biasa') {
                            ...
                            <option value="S">S : Lingkar Dada (50) & Lingkar Perut (67)</option>
                            <option value="M">M : Lingkar Dada (52) & Lingkar Perut (70)</option>
                            <option value="L">L : Lingkar Dada (54) & Lingkar Perut (73)</option>
                            <option value="XL">XL : Lingkar Dada (56) & Lingkar Perut (75)</option>
                            <option value="XXL">XXL : Lingkar Dada (58) & Lingkar Perut (78,5)</option>
                            <option value="3XL">3XL : Lingkar Dada (60) & Lingkar Perut (81,5)</option>
                            <option value="4XL">4XL : Lingkar Dada (62) & Lingkar Perut (84,5)</option>
                        `;
                        }
                    };

                    kepengurusanSelect.removeEventListener('change', changeHandler);
