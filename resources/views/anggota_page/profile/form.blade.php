                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" placeholder="Masukkan email Anda" value="{{ old('email', $user->email) }}"
                                required>
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="tel" class="form-control @error('nip_nipppk') is-invalid @enderror"
                                ...
                                value="{{ old('nip_nipppk', $user->anggota->nip_nipppk) }}" required>
                            @error('nip_nipppk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="tel" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp"
                                name="no_hp" placeholder="Masukkan nomor HP/WA Anda"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select" id="status_dosen" name="status_dosen">
                                <option value="" disabled
                                    ...
                                    dosen Anda</option>
                                <option value="Dosen PTN"
                                    {{ old('status_dosen', $user->anggota->status_dosen) == 'Dosen PTN' ? 'selected' : '' }}>
                                    Dosen PTN
                                </option>
                                <option value="Dosen DPK"
                                    {{ old('status_dosen', $user->anggota->status_dosen) == 'Dosen DPK' ? 'selected' : '' }}>
                                    Dosen DPK
                                </option>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select @error('provinsi') is-invalid @enderror" id="provinsi"
                                ...
                                @foreach ($daftar_provinsi as $prov)
                                    <option value="{{ $prov }}"
                                        {{ $provinsi_terpilih == $prov ? 'selected' : '' }}>
                                        {{ $prov }}
                                    </option>
                                @endforeach
                            </select>
