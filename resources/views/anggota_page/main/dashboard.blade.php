...
<div class="container-fluid">
    ...
    <div class="alert alert-primary mt-4" role="alert">
        ...
        <p>Halo, selamat datang di Dashboard Anggota. Silakan gunakan menu di samping untuk mengakses fitur-fitur yang
            tersedia.</p>
        <p>Klik tautan berikut untuk bergabung di WAG ANGGOTA TETAP ADAKSI --><a href="https://chat.whatsapp.com/J36cYGoe9DT8V5bssP7Ymt?mode=ac_c" target="blank"> Klik</a></p>
