    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-primary mt-4" role="alert">
            ...
            <p>Halo, selamat datang di Dashboard Anggota. Silakan gunakan menu di samping untuk mengakses fitur-fitur yang
                tersedia.</p>
            <p>Klik tautan berikut untuk bergabung di WAG ANGGOTA TETAP ADAKSI --><a
                    href="https://chat.whatsapp.com/J36cYGoe9DT8V5bssP7Ymt?mode=ac_c" target="blank"> Klik</a></p>
            <p>Klik tautan berikut untuk bergabung di Saluran WA ADAKSI --><a
                    href="https://whatsapp.com/channel/0029VbAU8q47DAX5TaAZhJ30" target="blank"> Klik</a></p>
        </div>
        ...
        <div class="row mt-4">
                    ...
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="card-title mb-1">
                                @if ($sisaHari !== null)
                                    {{ $sisaHari > 0 ? number_format($sisaHari, 0) . ' Hari' : 'Sudah Berakhir' }}
                                @else
                                    Tidak tersedia
                                @endif
                            </h5>
                            <p class="card-text mb-0">Keanggotaan Berakhir</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-3">
                <a href="/anggota/profile" class="card text-decoration-none text-dark h-100">
                    <div class="card-body d-flex align-items-center">
                        <i class="bi bi-person-circle fs-2 me-3"></i>
                        <div>
