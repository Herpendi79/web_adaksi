                                            ...
                                            <td>
                                                ...
                                                @if ($data->status == 'selesai' && in_array($data->id_wb, $webinar_terdaftar))
                                                    <button type="button"
                                                        ...
                                                        data-bs-target="#modalFasilitasDownload{{ $data->id_wb }}">
                                                        Download Fasilitas
                                                    </button>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="modalFasilitasDownload{{ $data->id_wb }}"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="modalLabel{{ $data->id_wb }}">Fasilitas
                                                                        Webinar</h5>
                                                                    ...
                                                                    @if ($data->fasilitas->isNotEmpty())
                                                                        <ul class="list-group">
                                                                            ...
                                                                            <li class="list-group-item">
                                                                                ...
                                                                                <a href="{{ url('anggota/sertifikat/' . $data->id_wb) }}"
                                                                                    target="_blank">Klik untuk Download</a>
                                                                            </li>
                                                                        </ul>
                                                                    @else
                                                                        <p class="text-muted">Tidak ada fasilitas tersedia
                                                                            untuk webinar ini.</p>
                                                                    @endif
                                                                </div>
                                                ...
                                                <div class="modal fade" id="modalDetil{{ $data->id_wb }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="modalLabel{{ $data->id_wb }}">Detil Webinar</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Tutup"></button>
                                                            </div>
                                                            <div class="modal-body">
