                            ...
                            <div class="col-md-5 mx-auto">
                                <div class="text-center">
                                    <div class="mb-0">
                                        ...
                                        <p class="text-dark">
                                            Halaman yang Anda cari tidak ditemukan. Mungkin telah dihapus, nama telah
                                            diubah, atau tidak tersedia sementara.
                                        </p>
                                    </div>

                                    <a class="btn btn-primary mt-3 me-1" href="{{ url('/') }}">Kembali</a>

                                    <div class="error-page mt-4">
                                        <img src="{{ url('/') }}/assets-template/images/svg/404-error.svg"
                                            class="img-fluid" alt="coming-soon">
                                    </div>
