 <ul id="side-menu">
     ...
     <li>
         ...
         <div class="collapse" id="sidebarKegiatan">
             <ul class="nav-second-level">
                 ...
                 <li>
                     <a href="{{ url('anggota/rakernas') }}" class="tp-link">Rakernas</a>
                 </li>
                 <li>
     ...
     <li>
         <a href="{{ route('anggota.tabulasi.index') }}" class="tp-link">
             <i data-feather="book"></i>
             <span> Tabulasi Anggota </span>
         </a>
     </li>
     <li>
         <a href="{{ route('aduan.index') }}" class="tp-link">
