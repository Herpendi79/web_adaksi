    ...
    <div class="container-fluid">
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Edit Rekening</h4>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('rekening.update', $rekening->id_rek) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-4">
                            ...
                            <input type="text" class="form-control @error('nama_bank') is-invalid @enderror"
                                ...
                                value="{{ $rekening->nama_bank ?? old('nama_bank') }}">
                            @error('nama_bank')
                        ...
                        <div class="mb-2 col-md-4">
                            ...
                            <input type="number" class="form-control @error('no_rek') is-invalid @enderror" id="no_rek"
                                name="no_rek" placeholder="Isi Nomor Rekening" 
                                value="{{ $rekening->no_rek ?? old('no_rek') }}">
                            @error('no_rek')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-2 col-md-4">
                            ...
                            <input type="text" class="form-control @error('atas_nama') is-invalid @enderror"
                                ...
                                value="{{ $rekening->atas_nama ?? old('atas_nama') }}">
                            @error('atas_nama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex justify-content-start mb-3">
                        <a href="{{ url('admin/rekening') }}" class="btn btn-secondary me-2">Kembali</a>
