    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('rakernas.update', $rakernas->id_rk) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-12">
                            ...
                            <input type="text" class="form-control @error('tema') is-invalid @enderror" id="tema"
                                name="tema" placeholder="Tema Rakernas" value="{{ $rakernas->tema ?? old('tema') }}">
                            @error('tema')
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-2">
                            ...
                            <input type="text" class="form-control @error('tempat') is-invalid @enderror" id="tempat"
                                name="tempat" placeholder="Misal: Jakarta"
                        ...
                        <div class="mb-2 col-md-1">
                            ...
                            <input type="number" class="form-control @error('kuota') is-invalid @enderror" id="kuota"
                                name="kuota" placeholder="..." value="{{ $rakernas->kuota ?? old('kuota') }}"
                        ...
                        <div class="mb-2 col-md-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_tutup') is-invalid @enderror"
                                ...
                                value="{{ $rakernas->tanggal_tutup ?? old('tanggal_tutup') }}">
                            @error('tanggal_tutup')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-2">
                            ...
                            <input type="text" class="form-control" id="biaya" name="biaya" placeholder="Rp...."
                                value="{{ $rakernas->biaya ?? old('biaya') }}">
                            @error('biaya')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-2 col-md-2">
                            ...
                            <input type="text" class="form-control" id="biaya_non_pengurus" name="biaya_non_pengurus"
                                placeholder="Rp...."
                                value="{{ $rakernas->biaya_non_pengurus ?? old('biaya_non_pengurus') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-2">
                            ...
                            <select class="form-select @error('angkatan') is-invalid @enderror" id="angkatan"
                                ...
                                <option value="III"
                                    {{ old('angkatan', $sertifikat->angkatan) == 'III' ? 'selected' : '' }}>III</option>
                            </select>
                            @error('angkatan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-2 col-md-2">
                            ...
                            <select class="form-select @error('unit') is-invalid @enderror" id="unit"
                                name="unit">
                                <option value="" disabled {{ old('unit', $sertifikat->unit) ? '' : 'selected' }}>--
                                    Pilih Unit -- </option>
                                <option value="DPP"
                                    {{ old('angkatan', $sertifikat->angkatan) == 'DPP' ? 'selected' : '' }}>DPP</option>
                                <option value="DPW"
                                    {{ old('angkatan', $sertifikat->angkatan) == 'DPW' ? 'selected' : '' }}>DPW</option>
                                <option value="DPC"
                                    {{ old('angkatan', $sertifikat->angkatan) == 'DPC' ? 'selected' : '' }}>DPC</option>
                            </select>
                            @error('unit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <select class="form-select @error('id_rek') is-invalid @enderror" id="id_rek"
                                ...
                                @foreach ($rekening as $rek)
                                    <option value="{{ $rek->id_rek }}"
                                        {{ (old('id_rek') ?? $rakernas->id_rek) == $rek->id_rek ? 'selected' : '' }}>
