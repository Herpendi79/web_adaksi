            ...
            <div class="card overflow-hidden">
                <div class="card-header">
                    <div class="d-md-flex align-items-center">
                        <div>
                            <p class="card-text text-muted mb-0">Berikut adalah Data Absensi yang terdaftar dalam
                                sistem.</p>
                        </div>
                        <form class="d-flex flex-stack flex-wrap gap-1 justify-content-md-end ms-auto">
                            ...
                            <select name="kehadiran"
                                ...
                                <option value="{{ $date->format('Y-m-d') }}" {{ request('kehadiran') == $date->format('Y-m-d') ? 'selected' : '' }}>
                        ...
                        <table class="table table-traffic mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($absen->kehadiran)->translatedFormat('d F Y') }}</td>
