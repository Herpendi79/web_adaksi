                    ...
                    <div class="d-md-flex align-items-center">
                        <div>
                            <h5 class="card-title mb-1">
                                Total Dana Diterima
                                <span class="text-danger">Rp. {{ number_format($total_masuk[$data->id_rk] ?? 0, 0, ',', '.') }}</span>
                            </h5>
                        ...
                        <table class="table table-traffic mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="mb-0 fw-medium fs-14">{{ $data->anggota->homebase_pt ?? '-' }}</p>
                                    </td>
                                    <td>
