    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('webinar.update', $webinar->id_wb) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-12">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                                name="judul" placeholder="Judul Webinar" value="{{ $webinar->judul ?? old('judul') }}">
                            @error('judul')
                    ...
                    <div class="row">
                        {{-- Deskripsi --}}
                        <div class="mb-2 col-md-12">
                            <label for="deskripsi" class="form-label m-0">Deskripsi (Detail Kegiatan, Sub Tema, Narsum
                                dll)</label>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-4">
                            ...
                            <input type="text" class="form-control @error('hari') is-invalid @enderror" id="hari"
                                name="hari" placeholder="Misal: Senin sd. Rabu"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-4">
                            ...
                            <input type="text" class="form-control @error('pukul') is-invalid @enderror" id="pukul"
                                name="pukul" placeholder="Misal : 19.00 - 21.00 WIB"
                        ...
                        <div class="row">
                            {{-- Anggota Aktif --}}
                            <div class="mb-2 col-md-4">
                                <label for="biaya_anggota_aktif_display" class="form-label m-0">Biaya Anggota
                                    Aktif</label>
                                <input type="text" class="form-control format-rupiah" id="biaya_anggota_aktif_display"
                                    placeholder="Rp....">
                            ...
                            {{-- Anggota Non Aktif --}}
                            <div class="mb-2 col-md-4">
                                <label for="biaya_anggota_non_aktif_display" class="form-label m-0">Biaya Anggota Non
                                    Aktif</label>
                                <input type="text" class="form-control format-rupiah"
                                    id="biaya_anggota_non_aktif_display" placeholder="Rp....">
                            ...
                            <div class="mb-2 col-md-4">
                                ...
                                <input type="text" class="form-control format-rupiah" id="biaya_non_anggota_display"
                                    placeholder="Rp....">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-4">
                                <label for="rekening" class="form-label m-0">Rekening Menampung Dana</label>
                                <select class="form-select @error('id_rek') is-invalid @enderror" id="id_rek"
                                    name="id_rek">
                                    <option value="">-- Pilih Rekening --</option>
                                    @foreach ($rekening as $rek)
                                        <option value="{{ $rek->id_rek }}"
                                            {{ (old('id_rek') ?? $webinar->id_rek) == $rek->id_rek ? 'selected' : '' }}>
                             ...
                             <script>
                                function toggleRekeningDropdown() {
                                    ...
                                    rekeningSelect.disabled = isFree;
                                ...
                                document.addEventListener('DOMContentLoaded', function() {
                                    toggleRekeningDropdown();

                                    document.getElementById('bayar').addEventListener('change', toggleRekeningDropdown);
                                    document.getElementById('free').addEventListener('change', toggleRekeningDropdown);
                                });
                            </script>
                            ...
                            <div class="mb-2 col-md-1">
                                <label for="no_surat" class="form-label m-0">No. Surat</label>
                    ...
                    <div class="row">
                        ...
                        <label for="fasilitas" class="form-label mb-1">Link Fasilitas (Misal :link PPT, link rekaman, link
                            undangan, link presensi dll)</label>
                        ...
                        <div id="fasilitas-container">
                            @foreach ($webinar->fasilitas as $i => $fas)
                                <div class="row mb-2 fasilitas-item">
                                    <input type="hidden" name="fasilitas[{{ $i }}][id_fas]"
                                        value="{{ $fas->id_fas }}">

                                    <div class="col-md-5">
                                        <label class="form-label m-0">Nama Fasilitas {{ $i + 1 }}</label>
                                        <input type="text"
                                            class="form-control @error(" fasilitas.$i.nama") is-invalid @enderror"
                                            name="fasilitas[{{ $i }}][nama]"
                                            value="{{ old("fasilitas.$i.nama", $fas->nama) }}">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="input-group">
                                            <input type="text"
                                                class="form-control @error(" fasilitas.$i.link") is-invalid @enderror"
                                                name="fasilitas[{{ $i }}][link]"
                                                value="{{ old("fasilitas.$i.link", $fas->link) }}"
