                    ...
                    <div class="card-header">
                        <div class="d-md-flex align-items-center">
                            <div>
                                ...
                                <p class="card-text text-muted mb-0">Berikut adalah daftar kegiatan Webinar yang terdaftar
                                    dalam
                                    sistem.</p>
                            </div>
                                    ...
                                    @foreach ($webinar as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button"
                                                    class="btn btn-sm btn-info mt-1 d-flex align-items-center gap-1"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalFasilitas{{ $data->id_wb }}">
                                                    Fasilitas
                                                </button>
                                                <!-- Modal -->
                                                <div class="modal fade" id="modalFasilitas{{ $data->id_wb }}"
                                                    tabindex="-1" aria-labelledby="modalLabel{{ $data->id_wb }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalLabel{{ $data->id_wb }}">
                                                                    Fasilitas Webinar</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        @foreach ($data->fasilitas as $fasilitas)
                                                                            <li class="list-group-item">
                                                                                ...
                                                                                @if ($fasilitas->link)
                                                                                    <a href="{{ $fasilitas->link }}"
                                                                                        target="_blank">{{ $fasilitas->link }}</a>
                                                                                @else
                                                                ...
                                                                @else
                                                                    <p class="text-muted">Tidak ada fasilitas tersedia untuk
                                                                        webinar ini.</p>
                                                                @endif
                                                            </div>
                                            ...
                                            <td>
                                                <button type="button"
                                                    class="btn btn-sm btn-info mt-1 d-flex align-items-center gap-1"
                                                    data-bs-toggle="modal" data-bs-target="#modalDetil{{ $data->id_wb }}">
                                                    Detil
                                                </button>
                                                <!-- Modal -->
                                                <div class="modal fade" id="modalDetil{{ $data->id_wb }}" tabindex="-1"
                                                    aria-labelledby="modalLabel{{ $data->id_wb }}" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalLabel{{ $data->id_wb }}">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p class="mb-0 fw-medium fs-14"><strong>Hari</strong>:
                                                                    {{ $data->hari }}</p>
                                                                <p class="mb-0 fw-medium fs-14">
                                                                ...
                                                                <p class="mb-0 fw-medium fs-14"><strong>Pukul</strong>:
                                                                    {{ $data->pukul }}</p>
                                                                <p class="mb-0 fw-medium fs-14"><strong>Link Zoom</strong>:
                                                                    <a href="{{ $data->link_zoom }}" target="blank">
                                                                        Klik</a></p>
                                                                <p class="mb-0 fw-medium fs-14">
                                                                    <strong>Kepesertaan</strong>: {{ $data->bayar_free }}
                                                                </p>
                                                                <p class="mb-0 fw-medium fs-14">
                                                                    <strong>Biaya</strong>: Anggota Aktif
                                                                    ({{ 'Rp. ' . number_format($data->biaya_anggota_aktif, 0, ',', '.') }}),
                                                                    Anggota Non Aktif
                                                                    ({{ 'Rp. ' . number_format($data->biaya_anggota_non_aktif, 0, ',', '.') }}),
                                                                    Non Anggota
                                                                    ({{ 'Rp. ' . number_format($data->biaya_non_anggota, 0, ',', '.') }})
                                                                </p>
                                                                <p class="mb-0 fw-medium fs-14"><strong>Moderator</strong>:
                                                                    {{ $data->moderator }}</p>
                                                                <p class="mb-0 fw-medium fs-14">
                                                                    <strong>Nama Bank</strong>:
                                                                    {{ $data->rekening->nama_bank ?? '-' }}
                                                                </p>
                                                                <p class="mb-0 fw-medium fs-14">
                                                                    <strong>Norek</strong>:
                                            ...
                                            <td>
                                                <a href="{{ asset('uploads/webinar/' . $data->flyer) }}"
                                                    target="_blank">Lihat</a>
                                            </td>
                                            <td>
                                                <a href="{{ asset('uploads/webinar/' . $data->sertifikat_depan) }}"
                                                    target="_blank">Lihat</a>
                                            </td>
                                            <td>
                                                <a href="{{ asset('uploads/webinar/' . $data->sertifikat_belakang) }}"
                                                    target="_blank">Lihat</a>
                                            </td>
                                            <td>
                                                @if (($jumlahPendaftarPerWebinar[$data->id_wb] ?? 0) > 0)
                                                    <p class="mb-0 fw-medium fs-14"> Valid:
                                                        {{ $valid[$data->id_wb] ?? 0 }}</p>
                                                    <p class="mb-0 fw-medium fs-14"> Pending:
                                                        {{ $pendaftarBelumTokenPerWebinar[$data->id_wb] ?? 0 }}</p>
                                            ...
                                            <td>
                                                <span class="text-danger">Rp.
                                                    {{ number_format($total_biaya[$data->id_wb] ?? 0, 0, ',', '.') }}</span>
                                            </td>
                                            ...
                                            <td>
                                                @if ($data->status == 'publish')
                                                    ...
                                                    <div class="modal fade" id="modalSelesai{{ $data->id_wb }}"
                                                        tabindex="-1" aria-labelledby="modalSelesai{{ $data->id_wb }}"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <form action="{{ url($url . '/selesai/' . $data->id_wb) }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Apakah Anda yakin ingin menyelesaikan webinar?
                                                                            Dengan ini maka peserta dapat mengunduh
                                                ...
                                                @elseif ($data->status == 'draft')
                                                    ...
                                                    <div class="modal fade" id="modalValidasi{{ $data->id_wb }}"
                                                        ...
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <form action="{{ url($url . '/publish/' . $data->id_wb) }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                            ...
                                            <td>
                                                ...
                                                @if ($data->status == 'draft')
                                                    ...
                                                    <div class="modal fade" id="modalHapus{{ $data->id_wb }}"
                                                        tabindex="-1" aria-labelledby="modalHapus{{ $data->id_wb }}"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <form action="{{ url($url . '/hapus/' . $data->id_wb) }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
