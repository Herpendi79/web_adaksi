                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-12">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                                name="judul" placeholder="Judul Webinar" value="{{ old('judul') }}">
                            @error('judul')
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-4">
                            ...
                            <input type="text" class="form-control @error('hari') is-invalid @enderror" id="hari"
                                name="hari" placeholder="Misal: Senin sd. Rabu" value="{{ old('hari') }}">
                            @error('hari')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-md-4">
                            ...
                            <input type="text" class="form-control @error('pukul') is-invalid @enderror" id="pukul"
                                name="pukul" placeholder="Misal : 19.00 - 21.00 WIB" value="{{ old('pukul') }}">
                            @error('pukul')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-4">
                                ...
                                <input type="text" class="form-control" id="biaya_anggota_aktif"
                                    name="biaya_anggota_aktif" placeholder="Rp...."
                                    value="{{ old('biaya_anggota_aktif') }}">
                            </div>

                            {{-- Anggota Non Aktif --}}
                            <div class="mb-2 col-md-4">
                                <label for="biaya_anggota_non_aktif" class="form-label m-0">Biaya Anggota Non
                                    Aktif</label>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-2">
                                <label for="angkatan" class="form-label m-0">Angkatan</label>
                        ...
                        <div class="row">
                            ...
                            <label for="fasilitas" class="form-label mb-1">Link Fasilitas (Misal :link PPT, link rekaman,
                                link undangan, link presensi dll)</label>
                                    ...
                                    <div class="row mb-2 fasilitas-item">
                                        <div class="col-md-5">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old("fasilitas.$i.nama") }}" placeholder="Nama Fasilitas">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="input-group">
                                                <input type="text"
                                                    ...
                                                    value="{{ old("fasilitas.$i.link") }}"
                                                    placeholder="Contoh -> https://www.adaksi.org/">
                                                <button type="button"
                                                    class="btn btn-danger remove-fasilitas">Batal</button>
                                            </div>
