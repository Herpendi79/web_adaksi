    ...
    <main class="container">
        ...
        <div class="col-lg-8 mx-auto">
            ...
            <div class="mainheading">
                <h1 class="posttitle">Kontak Kami</h1>
            </div>

            <div class="article-post serif-font">
                <p class="mb-4">Terima kasih atas kesediannya untuk kontak dengan kami. Anda dapat mengirim pesan melalui email resmi adaksi:</p>
                <h2><a href="mailto:mail@adaksi.org">mail@adaksi.org</a></h2>
                <h2><a href="https://wa.me/6281251226113" target="_blank">0812 5122 6113 (WA)</a></h2>
