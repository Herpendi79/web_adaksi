                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <p class="card-title-desc text-center"> Panduan cara pendaftaran dapat dilihat pada video
                                berikut:
                                <strong><a href="https://youtu.be/csOlYjhXklc" target="blank">Klik disini</a></strong>
                            </p>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="tel" inputmode="numeric" pattern="[0-9]*"
                                        ...
                                        maxlength="20" class="form-control @error('nip_nipppk') is-invalid @enderror"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="tel" inputmode="numeric" pattern="[0-9]*"
                                        oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="10"
                                        maxlength="15" class="form-control @error('no_hp') is-invalid @enderror"
